...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/TKOVURIKH8E1XS9CFW5AQQ/9DEA74AD-9EB8-4E33-9C20-E5B49271B471/art/data
AST_DATA_PATH=/tmp/applifire/db/TKOVURIKH8E1XS9CFW5AQQ/9DEA74AD-9EB8-4E33-9C20-E5B49271B471/ast/data
DB_NAME=applifire
USER=root
PASSWORD=Glass4#21
PORT=3306
...
MYSQL=/usr/bin
PROJECT_ID=TKOVURIKH8E1XS9CFW5AQQ
