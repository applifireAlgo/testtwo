...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "UserRoleBridge", complexity = Complexity.LOW)
...
public class UserRoleBridge implements Serializable, CommonEntityInterface, Comparator<UserRoleBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.authorization.UserRoleBridge other = (test.app.shared.authorization.UserRoleBridge) obj;
            if (roleUserMapId == null) {
                return false;
