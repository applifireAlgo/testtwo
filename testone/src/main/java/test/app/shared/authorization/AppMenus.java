...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "AppMenus", complexity = Complexity.LOW)
...
public class AppMenus implements Serializable, CommonEntityInterface, Comparator<AppMenus> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.authorization.AppMenus other = (test.app.shared.authorization.AppMenus) obj;
            if (menuId == null) {
                return false;
