package test.app.shared.authorization;
...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Roles", complexity = Complexity.LOW)
...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    public Roles addRoleMenuBridge(RoleMenuBridge _roleMenuBridge) {
        if (this.roleMenuBridge == null) {
            this.roleMenuBridge = new java.util.ArrayList<test.app.shared.authorization.RoleMenuBridge>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.authorization.Roles other = (test.app.shared.authorization.Roles) obj;
            if (roleId == null) {
                return false;
