...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "anagha", versionNumber = "3", comments = "RoleMenuBridge", complexity = Complexity.LOW)
...
public class RoleMenuBridge implements Serializable, CommonEntityInterface, Comparator<RoleMenuBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.authorization.RoleMenuBridge other = (test.app.shared.authorization.RoleMenuBridge) obj;
            if (roleMenuMapId == null) {
                return false;
