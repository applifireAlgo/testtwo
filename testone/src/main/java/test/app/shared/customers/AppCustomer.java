...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "AppCustomer", complexity = Complexity.LOW)
...
public class AppCustomer implements Serializable, CommonEntityInterface, Comparator<AppCustomer> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.customers.AppCustomer other = (test.app.shared.customers.AppCustomer) obj;
            if (appCustomerId == null) {
                return false;
