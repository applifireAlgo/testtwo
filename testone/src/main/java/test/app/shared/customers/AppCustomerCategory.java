package test.app.shared.customers;
...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "AppCustomerCategory", complexity = Complexity.LOW)
...
public class AppCustomerCategory implements Serializable, CommonEntityInterface, Comparator<AppCustomerCategory> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.customers.AppCustomerCategory other = (test.app.shared.customers.AppCustomerCategory) obj;
            if (appcustCategoryId == null) {
                return false;
