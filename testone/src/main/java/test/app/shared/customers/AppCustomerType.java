...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "AppCustomerType", complexity = Complexity.LOW)
...
public class AppCustomerType implements Serializable, CommonEntityInterface, Comparator<AppCustomerType> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.customers.AppCustomerType other = (test.app.shared.customers.AppCustomerType) obj;
            if (appcustTypeId == null) {
                return false;
