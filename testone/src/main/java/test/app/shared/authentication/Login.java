...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Login", complexity = Complexity.LOW)
...
public class Login implements Serializable, CommonEntityInterface, UserAuthentication, Comparator<Login> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.authentication.Login other = (test.app.shared.authentication.Login) obj;
            if (loginPk == null) {
                return false;
