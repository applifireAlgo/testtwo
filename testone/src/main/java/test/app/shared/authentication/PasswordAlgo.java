...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "PasswordAlgo", complexity = Complexity.LOW)
...
public class PasswordAlgo implements Serializable, CommonEntityInterface, PasswordAlgoInterface, Comparator<PasswordAlgo> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.authentication.PasswordAlgo other = (test.app.shared.authentication.PasswordAlgo) obj;
            if (algoId == null) {
                return false;
