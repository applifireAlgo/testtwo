...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "anagha", versionNumber = "2", comments = "UserData", complexity = Complexity.LOW)
...
public class UserData implements Serializable, CommonEntityInterface, UserDataInterface, Comparator<UserData> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.authentication.UserData other = (test.app.shared.authentication.UserData) obj;
            if (userDataId == null) {
                return false;
