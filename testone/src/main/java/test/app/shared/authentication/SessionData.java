...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "SessionData", complexity = Complexity.LOW)
...
public class SessionData implements Serializable, CommonEntityInterface, SessionDataInterface, Comparator<SessionData> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.authentication.SessionData other = (test.app.shared.authentication.SessionData) obj;
            if (dataId == null) {
                return false;
