package test.app.shared.authentication;
...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "User", complexity = Complexity.LOW)
...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    public User addPassRecovery(PassRecovery _passRecovery) {
        if (this.passRecovery == null) {
            this.passRecovery = new java.util.ArrayList<test.app.shared.authentication.PassRecovery>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.authentication.User other = (test.app.shared.authentication.User) obj;
            if (userId == null) {
                return false;
