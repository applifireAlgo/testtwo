...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "PasswordPolicy", complexity = Complexity.LOW)
...
public class PasswordPolicy implements Serializable, CommonEntityInterface, PasswordPolicyInterface, Comparator<PasswordPolicy> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.authentication.PasswordPolicy other = (test.app.shared.authentication.PasswordPolicy) obj;
            if (policyId == null) {
                return false;
