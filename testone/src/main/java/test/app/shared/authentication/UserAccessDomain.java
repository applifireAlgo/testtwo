...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "UserAccessDomain", complexity = Complexity.LOW)
...
public class UserAccessDomain implements Serializable, CommonEntityInterface, Comparator<UserAccessDomain> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.authentication.UserAccessDomain other = (test.app.shared.authentication.UserAccessDomain) obj;
            if (userAccessDomainId == null) {
                return false;
