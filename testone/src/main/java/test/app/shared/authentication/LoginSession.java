...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "LoginSession", complexity = Complexity.LOW)
public class LoginSession implements Serializable, CommonEntityInterface, LoginSessionInterface, Comparator<LoginSession> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.authentication.LoginSession other = (test.app.shared.authentication.LoginSession) obj;
            if (appSessionId == null) {
                return false;
