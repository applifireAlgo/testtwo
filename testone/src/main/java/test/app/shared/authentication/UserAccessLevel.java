...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "UserAccessLevel", complexity = Complexity.LOW)
...
public class UserAccessLevel implements Serializable, CommonEntityInterface, Comparator<UserAccessLevel> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.authentication.UserAccessLevel other = (test.app.shared.authentication.UserAccessLevel) obj;
            if (userAccessLevelId == null) {
                return false;
