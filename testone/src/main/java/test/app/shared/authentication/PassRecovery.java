...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "anagha", versionNumber = "3", comments = "PassRecovery", complexity = Complexity.LOW)
...
public class PassRecovery implements Serializable, CommonEntityInterface, PassRecoveryInterface, Comparator<PassRecovery> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.authentication.PassRecovery other = (test.app.shared.authentication.PassRecovery) obj;
            if (passRecoveryId == null) {
                return false;
