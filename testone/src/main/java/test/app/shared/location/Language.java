...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Language", complexity = Complexity.LOW)
...
public class Language implements Serializable, CommonEntityInterface, Comparator<Language> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.location.Language other = (test.app.shared.location.Language) obj;
            if (languageId == null) {
                return false;
