...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "State", complexity = Complexity.LOW)
...
public class State implements Serializable, CommonEntityInterface, Comparator<State> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.location.State other = (test.app.shared.location.State) obj;
            if (stateId == null) {
                return false;
