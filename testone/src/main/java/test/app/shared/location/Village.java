...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Village", complexity = Complexity.LOW)
...
public class Village implements Serializable, CommonEntityInterface, Comparator<Village> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.location.Village other = (test.app.shared.location.Village) obj;
            if (villageId == null) {
                return false;
