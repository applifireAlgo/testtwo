...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Currency", complexity = Complexity.LOW)
...
public class Currency implements Serializable, CommonEntityInterface, Comparator<Currency> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.location.Currency other = (test.app.shared.location.Currency) obj;
            if (currencyId == null) {
                return false;
