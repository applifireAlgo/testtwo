package test.app.shared.location;
...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "AddressExtended", complexity = Complexity.LOW)
...
public class AddressExtended implements Serializable, CommonEntityInterface, Comparator<AddressExtended> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.location.AddressExtended other = (test.app.shared.location.AddressExtended) obj;
            if (addExtId == null) {
                return false;
