...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Timezone", complexity = Complexity.LOW)
...
public class Timezone implements Serializable, CommonEntityInterface, TimeZoneInterface, Comparator<Timezone> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.location.Timezone other = (test.app.shared.location.Timezone) obj;
            if (timeZoneId == null) {
                return false;
