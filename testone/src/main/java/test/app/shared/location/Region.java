...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Region", complexity = Complexity.LOW)
...
public class Region implements Serializable, CommonEntityInterface, Comparator<Region> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.location.Region other = (test.app.shared.location.Region) obj;
            if (regionId == null) {
                return false;
