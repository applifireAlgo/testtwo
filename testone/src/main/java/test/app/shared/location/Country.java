...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Country", complexity = Complexity.LOW)
...
public class Country implements Serializable, CommonEntityInterface, Comparator<Country> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.location.Country other = (test.app.shared.location.Country) obj;
            if (countryId == null) {
                return false;
