...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Taluka", complexity = Complexity.LOW)
...
public class Taluka implements Serializable, CommonEntityInterface, Comparator<Taluka> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.location.Taluka other = (test.app.shared.location.Taluka) obj;
            if (talukaId == null) {
                return false;
