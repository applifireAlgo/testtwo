...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "City", complexity = Complexity.LOW)
...
public class City implements Serializable, CommonEntityInterface, Comparator<City> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.location.City other = (test.app.shared.location.City) obj;
            if (cityId == null) {
                return false;
