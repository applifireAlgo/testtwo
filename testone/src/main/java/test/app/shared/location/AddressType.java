...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "AddressType", complexity = Complexity.LOW)
...
public class AddressType implements Serializable, CommonEntityInterface, Comparator<AddressType> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.location.AddressType other = (test.app.shared.location.AddressType) obj;
            if (addressTypeId == null) {
                return false;
