...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "District", complexity = Complexity.LOW)
...
public class District implements Serializable, CommonEntityInterface, Comparator<District> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.location.District other = (test.app.shared.location.District) obj;
            if (districtId == null) {
                return false;
