...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "UserAccess", complexity = Complexity.LOW)
...
public class UserAccess implements Serializable, CommonEntityInterface, Comparator<UserAccess> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.sales.UserAccess other = (test.app.shared.sales.UserAccess) obj;
            if (userAccessId == null) {
                return false;
