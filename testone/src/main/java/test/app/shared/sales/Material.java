...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Material", complexity = Complexity.LOW)
...
public class Material implements Serializable, CommonEntityInterface, Comparator<Material> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.sales.Material other = (test.app.shared.sales.Material) obj;
            if (materialcode == null) {
                return false;
