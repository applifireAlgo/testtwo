...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Channel", complexity = Complexity.LOW)
...
public class Channel implements Serializable, CommonEntityInterface, Comparator<Channel> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.sales.Channel other = (test.app.shared.sales.Channel) obj;
            if (channelId == null) {
                return false;
