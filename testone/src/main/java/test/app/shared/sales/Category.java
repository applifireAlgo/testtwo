...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Category", complexity = Complexity.LOW)
...
public class Category implements Serializable, CommonEntityInterface, Comparator<Category> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.sales.Category other = (test.app.shared.sales.Category) obj;
            if (categoryId == null) {
                return false;
