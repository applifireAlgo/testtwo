...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "anagha", versionNumber = "4", comments = "Distributor", complexity = Complexity.LOW)
...
public class Distributor implements Serializable, CommonEntityInterface, Comparator<Distributor> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.sales.Distributor other = (test.app.shared.sales.Distributor) obj;
            if (distributorcode == null) {
                return false;
