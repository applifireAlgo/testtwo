...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "SalesData", complexity = Complexity.LOW)
...
public class SalesData implements Serializable, CommonEntityInterface, Comparator<SalesData> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.sales.SalesData other = (test.app.shared.sales.SalesData) obj;
            if (autoid == null) {
                return false;
