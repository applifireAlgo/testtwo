...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "CurrentMonth", complexity = Complexity.LOW)
...
public class CurrentMonth implements Serializable, CommonEntityInterface, Comparator<CurrentMonth> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.sales.CurrentMonth other = (test.app.shared.sales.CurrentMonth) obj;
            if (monthid == null) {
                return false;
