...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Retailer", complexity = Complexity.LOW)
...
public class Retailer implements Serializable, CommonEntityInterface, Comparator<Retailer> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.sales.Retailer other = (test.app.shared.sales.Retailer) obj;
            if (retailercode == null) {
                return false;
