...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Brand", complexity = Complexity.LOW)
...
public class Brand implements Serializable, CommonEntityInterface, Comparator<Brand> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.sales.Brand other = (test.app.shared.sales.Brand) obj;
            if (brandcode == null) {
                return false;
