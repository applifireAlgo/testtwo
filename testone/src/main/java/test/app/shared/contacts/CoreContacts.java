package test.app.shared.contacts;
...
import test.app.shared.EntityAudit;
import test.app.shared.SystemInfo;
...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "CoreContacts", complexity = Complexity.LOW)
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<test.app.shared.location.Address>();
        }
        if (_address != null) {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<test.app.shared.contacts.CommunicationData>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.contacts.CoreContacts other = (test.app.shared.contacts.CoreContacts) obj;
            if (contactId == null) {
                return false;
