...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "CommunicationGroup", complexity = Complexity.LOW)
...
public class CommunicationGroup implements Serializable, CommonEntityInterface, Comparator<CommunicationGroup> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.contacts.CommunicationGroup other = (test.app.shared.contacts.CommunicationGroup) obj;
            if (commGroupId == null) {
                return false;
