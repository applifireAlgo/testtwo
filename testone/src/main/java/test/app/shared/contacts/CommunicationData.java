...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "CommunicationData", complexity = Complexity.LOW)
...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.contacts.CommunicationData other = (test.app.shared.contacts.CommunicationData) obj;
            if (commDataId == null) {
                return false;
