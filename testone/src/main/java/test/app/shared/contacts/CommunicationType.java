...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "CommunicationType", complexity = Complexity.LOW)
...
public class CommunicationType implements Serializable, CommonEntityInterface, Comparator<CommunicationType> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.contacts.CommunicationType other = (test.app.shared.contacts.CommunicationType) obj;
            if (commType == null) {
                return false;
