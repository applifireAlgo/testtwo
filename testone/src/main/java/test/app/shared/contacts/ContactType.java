...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "ContactType", complexity = Complexity.LOW)
...
public class ContactType implements Serializable, CommonEntityInterface, Comparator<ContactType> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.contacts.ContactType other = (test.app.shared.contacts.ContactType) obj;
            if (contactTypeId == null) {
                return false;
