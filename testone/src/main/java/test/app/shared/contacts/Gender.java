...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Gender", complexity = Complexity.LOW)
...
public class Gender implements Serializable, CommonEntityInterface, Comparator<Gender> {
    ...
    public boolean equals(Object obj) {
        try {
            test.app.shared.contacts.Gender other = (test.app.shared.contacts.Gender) obj;
            if (genderId == null) {
                return false;
