...
import test.app.server.repository.CurrencyRepository;
...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Service for Currency Master table Entity", complexity = Complexity.LOW)
...
public class CurrencyServiceImpl extends CurrencyService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<test.app.shared.location.Currency> lstcurrency = currencyrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByCountryId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<test.app.shared.location.Currency> lstcurrency = currencyrepo.findByCountryId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcurrency);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            test.app.shared.location.Currency lstcurrency = currencyrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcurrency);
        } catch (org.springframework.transaction.TransactionException e) {
