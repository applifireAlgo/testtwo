...
public class ServiceAspect {
    ...
    @Pointcut("execution(* test.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    ...
    @Pointcut("execution(* test.app.server.service..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
