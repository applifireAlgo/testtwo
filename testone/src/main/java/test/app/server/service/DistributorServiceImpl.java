...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "anagha", versionNumber = "4", comments = "Service for Distributor Master table Entity", complexity = Complexity.LOW)
...
public class DistributorServiceImpl extends DistributorService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<test.app.shared.sales.Distributor> lstdistributor = distributorrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByRegioncode(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<test.app.shared.sales.Distributor> lstdistributor = distributorrepo.findByRegioncode((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstdistributor);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            test.app.shared.sales.Distributor lstdistributor = distributorrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstdistributor);
        } catch (org.springframework.transaction.TransactionException e) {
