...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Service for AppCustomerCategory Master table Entity", complexity = Complexity.LOW)
...
public class AppCustomerCategoryServiceImpl extends AppCustomerCategoryService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<test.app.shared.customers.AppCustomerCategory> lstappcustomercategory = appCustomerCategoryrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            test.app.shared.customers.AppCustomerCategory lstappcustomercategory = appCustomerCategoryrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstappcustomercategory);
        } catch (org.springframework.transaction.TransactionException e) {
