...
import test.app.server.repository.CurrentMonthRepository;
...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Service for CurrentMonth Master table Entity", complexity = Complexity.LOW)
...
public class CurrentMonthServiceImpl extends CurrentMonthService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<test.app.shared.sales.CurrentMonth> lstcurrentmonth = currentMonthrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            test.app.shared.sales.CurrentMonth lstcurrentmonth = currentMonthrepo.findById((java.lang.Integer) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstcurrentmonth);
        } catch (org.springframework.transaction.TransactionException e) {
