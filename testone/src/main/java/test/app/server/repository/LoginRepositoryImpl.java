...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for Login Transaction table", complexity = Complexity.MEDIUM)
public class LoginRepositoryImpl extends SearchInterfaceImpl implements LoginRepository<Login> {
    ...
    public List<Login> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.authentication.Login> query = emanager.createQuery("select u from Login u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Login> save(List<Login> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.authentication.Login obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.authentication.Login s = emanager.find(test.app.shared.authentication.Login.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Login> findByUserId(String userId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.authentication.Login> listOfLogin = query.getResultList();
            return listOfLogin;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Login findById(String loginPk) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.authentication.Login listOfLogin = (test.app.shared.authentication.Login) query.getSingleResult();
            return listOfLogin;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
