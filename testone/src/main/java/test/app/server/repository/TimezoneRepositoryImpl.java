...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for Timezone Master table Entity", complexity = Complexity.LOW)
public class TimezoneRepositoryImpl extends SearchInterfaceImpl implements TimezoneRepository<Timezone> {
    ...
    public List<Timezone> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.Timezone> query = emanager.createQuery("select u from Timezone u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Timezone> save(List<Timezone> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.location.Timezone obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.location.Timezone s = emanager.find(test.app.shared.location.Timezone.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Timezone findById(String timeZoneId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.location.Timezone listOfTimezone = (test.app.shared.location.Timezone) query.getSingleResult();
