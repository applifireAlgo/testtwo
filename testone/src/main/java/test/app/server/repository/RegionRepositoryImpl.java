...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for Region Master table Entity", complexity = Complexity.LOW)
public class RegionRepositoryImpl extends SearchInterfaceImpl implements RegionRepository<Region> {
    ...
    public List<Region> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.Region> query = emanager.createQuery("select u from Region u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Region> save(List<Region> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.location.Region obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.location.Region s = emanager.find(test.app.shared.location.Region.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Region> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.Region> listOfRegion = query.getResultList();
            return listOfRegion;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Region findById(String regionId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.location.Region listOfRegion = (test.app.shared.location.Region) query.getSingleResult();
            return listOfRegion;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
