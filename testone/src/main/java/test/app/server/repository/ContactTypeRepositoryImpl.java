...
import test.app.shared.contacts.ContactType;
...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for ContactType Master table Entity", complexity = Complexity.LOW)
public class ContactTypeRepositoryImpl extends SearchInterfaceImpl implements ContactTypeRepository<ContactType> {
    ...
    public List<ContactType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.contacts.ContactType> query = emanager.createQuery("select u from ContactType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<ContactType> save(List<ContactType> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.contacts.ContactType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.contacts.ContactType s = emanager.find(test.app.shared.contacts.ContactType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public ContactType findById(String contactTypeId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.contacts.ContactType listOfContactType = (test.app.shared.contacts.ContactType) query.getSingleResult();
