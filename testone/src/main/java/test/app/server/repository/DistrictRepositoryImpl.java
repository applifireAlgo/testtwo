...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for District Master table Entity", complexity = Complexity.LOW)
public class DistrictRepositoryImpl extends SearchInterfaceImpl implements DistrictRepository<District> {
    ...
    public List<District> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.District> query = emanager.createQuery("select u from District u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<District> save(List<District> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.location.District obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.location.District s = emanager.find(test.app.shared.location.District.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<District> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.District> listOfDistrict = query.getResultList();
    ...
    public District findById(String districtId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.location.District listOfDistrict = (test.app.shared.location.District) query.getSingleResult();
            return listOfDistrict;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
