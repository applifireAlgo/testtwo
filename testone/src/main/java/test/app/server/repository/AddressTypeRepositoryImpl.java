...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for AddressType Master table Entity", complexity = Complexity.LOW)
public class AddressTypeRepositoryImpl extends SearchInterfaceImpl implements AddressTypeRepository<AddressType> {
    ...
    public List<AddressType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.AddressType> query = emanager.createQuery("select u from AddressType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AddressType> save(List<AddressType> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.location.AddressType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.location.AddressType s = emanager.find(test.app.shared.location.AddressType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public AddressType findById(String addressTypeId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.location.AddressType listOfAddressType = (test.app.shared.location.AddressType) query.getSingleResult();
