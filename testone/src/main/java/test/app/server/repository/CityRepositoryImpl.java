...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for City Master table Entity", complexity = Complexity.LOW)
public class CityRepositoryImpl extends SearchInterfaceImpl implements CityRepository<City> {
    ...
    public List<City> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.City> query = emanager.createQuery("select u from City u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<City> save(List<City> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.location.City obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.location.City s = emanager.find(test.app.shared.location.City.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<City> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.City> listOfCity = query.getResultList();
            return listOfCity;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public City findById(String cityId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.location.City listOfCity = (test.app.shared.location.City) query.getSingleResult();
            return listOfCity;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
