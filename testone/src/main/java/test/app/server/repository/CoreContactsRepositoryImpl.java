...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for CoreContacts Transaction table", complexity = Complexity.MEDIUM)
public class CoreContactsRepositoryImpl extends SearchInterfaceImpl implements CoreContactsRepository<CoreContacts> {
    ...
    public List<CoreContacts> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.contacts.CoreContacts> query = emanager.createQuery("select u from CoreContacts u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public CoreContacts save(CoreContacts entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<test.app.shared.location.Address> address = new java.util.ArrayList<test.app.shared.location.Address>();
            for (java.util.Iterator iterator = entity.getAddress().iterator(); iterator.hasNext(); ) {
                test.app.shared.location.Address childEntity = (test.app.shared.location.Address) iterator.next();
                if (childEntity.getPrimaryKey() != null) {
                    test.app.shared.location.Address ans = emanager.find(Address.class, childEntity.getPrimaryKey());
                    address.add(ans);
                } else {
                    address.add(childEntity);
                }
            }
            java.util.List<test.app.shared.contacts.CommunicationData> communicationdata = new java.util.ArrayList<test.app.shared.contacts.CommunicationData>();
            for (java.util.Iterator iterator = entity.getCommunicationData().iterator(); iterator.hasNext(); ) {
                test.app.shared.contacts.CommunicationData childEntity = (test.app.shared.contacts.CommunicationData) iterator.next();
                if (childEntity.getPrimaryKey() != null) {
                    test.app.shared.contacts.CommunicationData ans = emanager.find(CommunicationData.class, childEntity.getPrimaryKey());
    ...
    public List<CoreContacts> save(List<CoreContacts> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.contacts.CoreContacts obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.contacts.CoreContacts s = emanager.find(test.app.shared.contacts.CoreContacts.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public void deleteAddress(List<Address> address) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (test.app.shared.location.Address _address : address) {
                test.app.shared.location.Address s = emanager.find(test.app.shared.location.Address.class, _address.getAddressId());
                emanager.remove(s);
            }
        } catch (javax.persistence.PersistenceException e) {
            throw new SpartanPersistenceException("Error in deleting entity", e);
    ...
    public void deleteCommunicationData(List<CommunicationData> communicationdata) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (test.app.shared.contacts.CommunicationData _communicationdata : communicationdata) {
                test.app.shared.contacts.CommunicationData s = emanager.find(test.app.shared.contacts.CommunicationData.class, _communicationdata.getCommDataId());
                emanager.remove(s);
            }
        } catch (javax.persistence.PersistenceException e) {
            throw new SpartanPersistenceException("Error in deleting entity", e);
    ...
    public List<CoreContacts> findByTitleId(String titleId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.contacts.CoreContacts> listOfCoreContacts = query.getResultList();
    ...
    public CoreContacts findById(String contactId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.contacts.CoreContacts listOfCoreContacts = (test.app.shared.contacts.CoreContacts) query.getSingleResult();
            return listOfCoreContacts;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
