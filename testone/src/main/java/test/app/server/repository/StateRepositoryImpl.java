...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for State Master table Entity", complexity = Complexity.LOW)
public class StateRepositoryImpl extends SearchInterfaceImpl implements StateRepository<State> {
    ...
    public List<State> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.State> query = emanager.createQuery("select u from State u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<State> save(List<State> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.location.State obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.location.State s = emanager.find(test.app.shared.location.State.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<State> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.State> listOfState = query.getResultList();
            return listOfState;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public State findById(String stateId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.location.State listOfState = (test.app.shared.location.State) query.getSingleResult();
            return listOfState;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
