...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for Gender Master table Entity", complexity = Complexity.LOW)
public class GenderRepositoryImpl extends SearchInterfaceImpl implements GenderRepository<Gender> {
    ...
    public List<Gender> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.contacts.Gender> query = emanager.createQuery("select u from Gender u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Gender> save(List<Gender> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.contacts.Gender obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.contacts.Gender s = emanager.find(test.app.shared.contacts.Gender.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Gender findById(String genderId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.contacts.Gender listOfGender = (test.app.shared.contacts.Gender) query.getSingleResult();
            return listOfGender;
        } catch (javax.persistence.PersistenceException e) {
