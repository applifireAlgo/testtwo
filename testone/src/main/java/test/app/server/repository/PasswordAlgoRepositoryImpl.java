...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for PasswordAlgo Master table Entity", complexity = Complexity.LOW)
public class PasswordAlgoRepositoryImpl extends SearchInterfaceImpl implements PasswordAlgoRepository<PasswordAlgo> {
    ...
    public List<PasswordAlgo> save(List<PasswordAlgo> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.authentication.PasswordAlgo obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.authentication.PasswordAlgo s = emanager.find(test.app.shared.authentication.PasswordAlgo.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public PasswordAlgo findById(String algoId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.authentication.PasswordAlgo listOfPasswordAlgo = (test.app.shared.authentication.PasswordAlgo) query.getSingleResult();
