...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for Country Master table Entity", complexity = Complexity.LOW)
public class CountryRepositoryImpl extends SearchInterfaceImpl implements CountryRepository<Country> {
    ...
    public List<Country> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.Country> query = emanager.createQuery("select u from Country u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Country> save(List<Country> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.location.Country obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.location.Country s = emanager.find(test.app.shared.location.Country.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Country findById(String countryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.location.Country listOfCountry = (test.app.shared.location.Country) query.getSingleResult();
