...
import test.app.shared.location.Currency;
...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for Currency Master table Entity", complexity = Complexity.LOW)
public class CurrencyRepositoryImpl extends SearchInterfaceImpl implements CurrencyRepository<Currency> {
    ...
    public List<Currency> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.Currency> query = emanager.createQuery("select u from Currency u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Currency> save(List<Currency> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.location.Currency obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.location.Currency s = emanager.find(test.app.shared.location.Currency.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Currency> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.Currency> listOfCurrency = query.getResultList();
    ...
    public Currency findById(String currencyId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.location.Currency listOfCurrency = (test.app.shared.location.Currency) query.getSingleResult();
            return listOfCurrency;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
