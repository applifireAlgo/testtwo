...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for CommunicationType Master table Entity", complexity = Complexity.LOW)
public class CommunicationTypeRepositoryImpl extends SearchInterfaceImpl implements CommunicationTypeRepository<CommunicationType> {
    ...
    public List<CommunicationType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.contacts.CommunicationType> query = emanager.createQuery("select u from CommunicationType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<CommunicationType> save(List<CommunicationType> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.contacts.CommunicationType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.contacts.CommunicationType s = emanager.find(test.app.shared.contacts.CommunicationType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<CommunicationType> findByCommGroupId(String commGroupId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.contacts.CommunicationType> listOfCommunicationType = query.getResultList();
    ...
    public CommunicationType findById(String commType) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.contacts.CommunicationType listOfCommunicationType = (test.app.shared.contacts.CommunicationType) query.getSingleResult();
            return listOfCommunicationType;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
