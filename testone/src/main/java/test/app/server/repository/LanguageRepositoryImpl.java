...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for Language Master table Entity", complexity = Complexity.LOW)
public class LanguageRepositoryImpl extends SearchInterfaceImpl implements LanguageRepository<Language> {
    ...
    public List<Language> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.Language> query = emanager.createQuery("select u from Language u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Language> save(List<Language> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.location.Language obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.location.Language s = emanager.find(test.app.shared.location.Language.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Language findById(String languageId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.location.Language listOfLanguage = (test.app.shared.location.Language) query.getSingleResult();
