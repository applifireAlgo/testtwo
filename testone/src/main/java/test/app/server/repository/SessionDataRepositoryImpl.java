...
import test.app.shared.authentication.SessionData;
...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for SessionData Transaction table", complexity = Complexity.MEDIUM)
public class SessionDataRepositoryImpl extends SearchInterfaceImpl implements SessionDataRepository<SessionData> {
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.authentication.SessionData s = emanager.find(test.app.shared.authentication.SessionData.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
