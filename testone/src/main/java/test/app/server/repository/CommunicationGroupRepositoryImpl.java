...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for CommunicationGroup Master table Entity", complexity = Complexity.LOW)
public class CommunicationGroupRepositoryImpl extends SearchInterfaceImpl implements CommunicationGroupRepository<CommunicationGroup> {
    ...
    public List<CommunicationGroup> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.contacts.CommunicationGroup> query = emanager.createQuery("select u from CommunicationGroup u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<CommunicationGroup> save(List<CommunicationGroup> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.contacts.CommunicationGroup obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.contacts.CommunicationGroup s = emanager.find(test.app.shared.contacts.CommunicationGroup.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public CommunicationGroup findById(String commGroupId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.contacts.CommunicationGroup listOfCommunicationGroup = (test.app.shared.contacts.CommunicationGroup) query.getSingleResult();
