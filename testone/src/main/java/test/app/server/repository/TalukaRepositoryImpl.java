...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for Taluka Master table Entity", complexity = Complexity.LOW)
public class TalukaRepositoryImpl extends SearchInterfaceImpl implements TalukaRepository<Taluka> {
    ...
    public List<Taluka> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.Taluka> query = emanager.createQuery("select u from Taluka u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Taluka> save(List<Taluka> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.location.Taluka obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.location.Taluka s = emanager.find(test.app.shared.location.Taluka.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Taluka> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.Taluka> listOfTaluka = query.getResultList();
            return listOfTaluka;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Taluka findById(String talukaId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.location.Taluka listOfTaluka = (test.app.shared.location.Taluka) query.getSingleResult();
            return listOfTaluka;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
