...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for Address Transaction table", complexity = Complexity.MEDIUM)
public class AddressRepositoryImpl extends SearchInterfaceImpl implements AddressRepository<Address> {
    ...
    public List<Address> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.Address> query = emanager.createQuery("select u from Address u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Address> save(List<Address> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.location.Address obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.location.Address s = emanager.find(test.app.shared.location.Address.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Address> findByAddressTypeId(String addressTypeId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.location.Address> listOfAddress = query.getResultList();
    ...
    public Address findById(String addressId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.location.Address listOfAddress = (test.app.shared.location.Address) query.getSingleResult();
            return listOfAddress;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
