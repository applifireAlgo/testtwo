...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for AppCustomerCategory Master table Entity", complexity = Complexity.LOW)
public class AppCustomerCategoryRepositoryImpl extends SearchInterfaceImpl implements AppCustomerCategoryRepository<AppCustomerCategory> {
    ...
    public List<AppCustomerCategory> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.customers.AppCustomerCategory> query = emanager.createQuery("select u from AppCustomerCategory u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AppCustomerCategory> save(List<AppCustomerCategory> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.customers.AppCustomerCategory obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.customers.AppCustomerCategory s = emanager.find(test.app.shared.customers.AppCustomerCategory.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public AppCustomerCategory findById(String appcustCategoryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.customers.AppCustomerCategory listOfAppCustomerCategory = (test.app.shared.customers.AppCustomerCategory) query.getSingleResult();
