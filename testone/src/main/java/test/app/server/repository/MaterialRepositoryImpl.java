...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for Material Master table Entity", complexity = Complexity.LOW)
public class MaterialRepositoryImpl extends SearchInterfaceImpl implements MaterialRepository<Material> {
    ...
    public List<Material> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.sales.Material> query = emanager.createQuery("select u from Material u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Material> save(List<Material> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.sales.Material obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.sales.Material s = emanager.find(test.app.shared.sales.Material.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Material> findByBrandcode(String brandcode) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.sales.Material> listOfMaterial = query.getResultList();
    ...
    public Material findById(String materialcode) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.sales.Material listOfMaterial = (test.app.shared.sales.Material) query.getSingleResult();
            return listOfMaterial;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
