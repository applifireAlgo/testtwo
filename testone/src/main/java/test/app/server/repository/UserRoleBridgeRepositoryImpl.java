...
import test.app.shared.authorization.UserRoleBridge;
...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for UserRoleBridge Transaction table", complexity = Complexity.MEDIUM)
public class UserRoleBridgeRepositoryImpl extends SearchInterfaceImpl implements UserRoleBridgeRepository<UserRoleBridge> {
    ...
    public List<UserRoleBridge> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.authorization.UserRoleBridge> query = emanager.createQuery("select u from UserRoleBridge u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<UserRoleBridge> save(List<UserRoleBridge> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.authorization.UserRoleBridge obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.authorization.UserRoleBridge s = emanager.find(test.app.shared.authorization.UserRoleBridge.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<UserRoleBridge> findByRoleId(String roleId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.authorization.UserRoleBridge> listOfUserRoleBridge = query.getResultList();
    ...
    public UserRoleBridge findById(String roleUserMapId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.authorization.UserRoleBridge listOfUserRoleBridge = (test.app.shared.authorization.UserRoleBridge) query.getSingleResult();
            return listOfUserRoleBridge;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
