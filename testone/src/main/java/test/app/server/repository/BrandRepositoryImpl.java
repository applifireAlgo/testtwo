...
public class BrandRepositoryImpl extends SearchInterfaceImpl implements BrandRepository<Brand> {
    ...
    public List<Brand> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.sales.Brand> query = emanager.createQuery("select u from Brand u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Brand> save(List<Brand> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.sales.Brand obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.sales.Brand s = emanager.find(test.app.shared.sales.Brand.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Brand> findByCategoryId(String categoryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.sales.Brand> listOfBrand = query.getResultList();
            return listOfBrand;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Brand findById(String brandcode) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.sales.Brand listOfBrand = (test.app.shared.sales.Brand) query.getSingleResult();
            return listOfBrand;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
