...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for AppMenus Master table Entity", complexity = Complexity.LOW)
public class AppMenusRepositoryImpl extends SearchInterfaceImpl implements AppMenusRepository<AppMenus> {
    ...
    public List<AppMenus> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.authorization.AppMenus> query = emanager.createQuery("select u from AppMenus u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AppMenus> save(List<AppMenus> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.authorization.AppMenus obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.authorization.AppMenus s = emanager.find(test.app.shared.authorization.AppMenus.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public AppMenus findById(String menuId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.authorization.AppMenus listOfAppMenus = (test.app.shared.authorization.AppMenus) query.getSingleResult();
