...
@SourceCodeAuthorClass(createdBy = "anagha", updatedBy = "", versionNumber = "1", comments = "Repository for AppCustomerType Master table Entity", complexity = Complexity.LOW)
public class AppCustomerTypeRepositoryImpl extends SearchInterfaceImpl implements AppCustomerTypeRepository<AppCustomerType> {
    ...
    public List<AppCustomerType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<test.app.shared.customers.AppCustomerType> query = emanager.createQuery("select u from AppCustomerType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AppCustomerType> save(List<AppCustomerType> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                test.app.shared.customers.AppCustomerType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            test.app.shared.customers.AppCustomerType s = emanager.find(test.app.shared.customers.AppCustomerType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public AppCustomerType findById(String appcustTypeId) throws Exception, SpartanPersistenceException {
        try {
            ...
            test.app.shared.customers.AppCustomerType listOfAppCustomerType = (test.app.shared.customers.AppCustomerType) query.getSingleResult();
