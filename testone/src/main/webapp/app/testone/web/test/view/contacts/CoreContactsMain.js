Ext.define('Testone.testone.web.test.view.contacts.CoreContactsMain', {
     ...
     "requires": ["Testone.testone.shared.test.model.contacts.CoreContactsModel", "Testone.testone.web.test.controller.contacts.CoreContactsMainController", "Testone.testone.shared.test.model.contacts.TitleModel", "Testone.testone.shared.test.model.location.LanguageModel", "Testone.testone.shared.test.model.contacts.GenderModel", "Testone.view.fw.component.Grids", "Testone.testone.shared.test.model.location.AddressTypeModel", "Testone.testone.shared.test.model.location.CountryModel", "Testone.testone.shared.test.model.location.StateModel", "Testone.testone.shared.test.model.location.CityModel", "Testone.view.fw.component.Grids", "Testone.testone.shared.test.model.contacts.CommunicationGroupModel", "Testone.testone.shared.test.model.contacts.CommunicationTypeModel", "Testone.testone.shared.test.viewmodel.contacts.CoreContactsViewModel"],
     "communicationLog": [],
     "tabPosition": "bottom",
     "items": [{
          "title": "Data Browser",
                    ...
                    "items": [{
                         ...
                         "items": [{
                              ...
                              "items": [{
                                   ...
                                   "fieldId": "F568658D-ED18-461B-9E23-47D4A4877935",
                                   "minLength": "0",
                                   "maxLength": "64",
                                   "hidden": true,
                                   "value": "",
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "DD30E3B1-70B7-4637-A78C-DFA485FFDE51",
                                   ...
                                   "store": {
                                        "data": [],
                                        "model": "Testone.testone.shared.test.model.contacts.TitleModel"
                                   },
                                   "bindable": "titleId",
                                   "columnWidth": 0.5,
                                   "bind": "{titleId}"
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "0D2A15E6-BC05-4F0F-A5E9-B8DB9952497B",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "fieldId": "EE359C71-5968-4979-862C-2B1153781A8A",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   "bindable": "middleName",
                                   "columnWidth": 0.5,
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "0A6EB1E1-7635-49CA-B4D7-211B42065123",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "fieldId": "E9345454-B481-4D36-9C24-475A468C5364",
                                   ...
                                   "store": {
                                        "data": [],
                                        "model": "Testone.testone.shared.test.model.location.LanguageModel"
                                   },
                                   ...
                                   "fieldId": "0B6BF5B9-AD69-41FB-960E-E5BAAE219EBF",
                                   "displayField": "primaryDisplay",
                                   "valueField": "primaryKey",
                                   "typeAhead": true,
                                   "queryMode": "local",
                                   ...
                                   "fieldId": "B17E332B-1153-4999-91AD-61A8CED1ABF7",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "fieldId": "1C2DE933-2319-416D-BD30-03FEC56B282C",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "fieldId": "05342C68-D15F-4C8B-B31C-592E6998C096",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "2C670805-6C67-4FCA-BE2A-D7F9F3CE34B1",
                                   "errorMessage": "Please enter gender",
                                   "restURL": "Gender",
                                   "displayField": "primaryDisplay",
                                   "valueField": "primaryKey",
                                   ...
                                   "store": {
                                        "data": [],
                                        "model": "Testone.testone.shared.test.model.contacts.GenderModel"
                                   },
                                   "bindable": "genderId",
                                   "columnWidth": 0.5,
                                   "bind": "{genderId}"
                                   ...
                                   "margin": "5 5 5 5",
                                   "fieldLabel": "DOB",
                                   "fieldId": "0353CCB7-6301-440E-8C9B-22961735DB2E",
                                   ...
                                   "margin": "5 5 5 5",
                                   "fieldLabel": "Age",
                                   "fieldId": "7107CA64-A130-404F-A67B-7175A3F0F6D7",
                                   "minValue": "0",
                                   "maxValue": "125",
                                   "bindable": "age",
                                   "columnWidth": 0.5,
                                   ...
                                   "fieldId": "BBFC37EF-31AF-45ED-ABD5-D1D9F7BACC8E",
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "5A7992A5-2364-421F-B854-ED09B3235FBB",
                                   "minLength": "0",
                                   "maxLength": "256",
                                   ...
                                   "allowBlank": false,
                                   "fieldId": "208B782F-FE68-40C8-A3EE-D18B560BD7D2",
                                   "minLength": "0",
                                   "maxLength": "20",
                                   ...
                                   "fieldId": "63E1E87C-96C6-4129-A486-0ADB6EC52457",
                                   "bindable": "versionId",
                                   "bind": "{versionId}",
                                   "hidden": true
                              }]
                         ...
                         "items": [{
                              ...
                              "items": [{
                                   ...
                                   "items": [{
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "B665C628-CB47-45AE-8381-084CB9F711BD",
                                        ...
                                        "store": {
                                             "data": [],
                                             "model": "Testone.testone.shared.test.model.location.AddressTypeModel"
                                        },
                                        ...
                                        "fieldId": "D3DA7727-0205-4C7D-AB1A-ED505E6D8C91",
                                        "minLength": "0",
                                        "maxLength": "11",
                                        ...
                                        "margin": "5 5 5 5",
                                        "fieldLabel": "Address1",
                                        "fieldId": "5B36A7EA-7753-4EFD-985E-3E4E3BB7A24A",
                                        ...
                                        "margin": "5 5 5 5",
                                        "fieldLabel": "Address2",
                                        "fieldId": "A148BF78-C725-4267-9FAC-D053674EB89A",
                                        ...
                                        "margin": "5 5 5 5",
                                        "fieldLabel": "Address3",
                                        "fieldId": "7BFA7B1B-4804-4389-8EAC-D67B398D7721",
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "BB017132-F7C3-4C91-9FC3-3DA5E8C8B9B9",
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "10D8078B-34DA-4C37-849B-FB8E48EE3D10",
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "85075885-4C0A-413A-AE3A-6F30A4AD7E95",
                                        ...
                                        "store": {
                                             "data": [],
                                             "model": "Testone.testone.shared.test.model.location.CityModel"
                                        },
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "B62A960B-B52B-44DA-B1A0-A184FC976A15",
                                        "minLength": "0",
                                        "maxLength": "6",
                                        ...
                                        "margin": "5 5 5 5",
                                        "fieldLabel": "Latitude",
                                        "fieldId": "801EE2A1-82DD-4222-A5D0-C22C1DB915ED",
                                        "minLength": "0",
                                        "maxLength": "64",
                                        ...
                                        "fieldId": "03F22DDE-E30C-4885-AD56-EA944FBC792F",
                                        "minLength": "0",
                                        "maxLength": "64",
                         ...
                         "items": [{
                              ...
                              "items": [{
                                   ...
                                   "items": [{
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "C13939D7-76F4-4793-B701-9238210B6FF7",
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "389F61EA-2488-4D1A-8C9A-4033DF889A3A",
                                        ...
                                        "store": {
                                             "data": [],
                                             "model": "Testone.testone.shared.test.model.contacts.CommunicationTypeModel"
                                        },
                                        ...
                                        "allowBlank": false,
                                        "fieldId": "D2BA00CD-612E-4DA6-8567-712977404DC0",
                                        "minLength": "0",
