...
import test.app.server.repository.UserAccessRepository;
import test.app.shared.sales.UserAccess;
...
public class UserAccessTestCase {
    ...
    public void test1Save() {
        try {
            ...
            salesregion.setRegionname("zr4VLtj5sOiHVNUw7dWaBJDZnRpEc3c2aWNMopSt8kXXhZvd8Y");
            ...
            user.setPasswordAlgo("XmnxYirnmOwdzLjMwc7SPZYIW0YEJ1jarBddBECDYBnAOLtm3m");
            user.setPasswordExpiryDate(new java.sql.Timestamp(123456789));
            user.setSessionTimeout(1464);
            user.setUserAccessCode(11);
            UserAccessDomain useraccessdomain = new UserAccessDomain();
            useraccessdomain.setDomainDescription("uHUTmnDkihww9Kmr7j4DMq2y2QE8vyobhvMOimkyPt502Uyus7");
            useraccessdomain.setDomainHelp("gVrGnx8ThDRwZsL2YGOmZitkqgjxDhSyYuGnuy70SfcNgda5GX");
            useraccessdomain.setDomainIcon("2LSujWKzscpIWU5dgsSEFNt078VRuPpaJrQg6oijoBFJ6cSNvv");
            useraccessdomain.setDomainName("Nnx4bn2IbzAbGId5DSzfmNpe9cudPXfcFdX0jNTIUhuBetqSkA");
            useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
            UserAccessDomain UserAccessDomainTest = useraccessdomainRepository.save(useraccessdomain);
            map.put("UserAccessDomainPrimaryKey", useraccessdomain._getPrimarykey());
            UserAccessLevel useraccesslevel = new UserAccessLevel();
            useraccesslevel.setLevelDescription("j5BD5MzzrrpE8C7cu3RwsAsPRVtIYKRIwzUIPgpBfCEh8rhIdo");
            useraccesslevel.setLevelHelp("E0UAqvY0AhHpYCzMVWms4lHsxjNDdI7KH0pfOSMpo2r01woE10");
            useraccesslevel.setLevelIcon("SYJfd7NZ93kRwBgUq4YsfSBKkJswzbX52i1wI5jdXsk1LgYKa5");
            useraccesslevel.setLevelName("HyItQ0vGmaiEFs29ikFTxmjsfAvyUVOIzQ93aDEq6udIIULKMS");
            ...
            user.setPasswordAlgo("kNR86bqwAdboUaX7I1lIdMQZi6KYjVXCFUNo8tPwbyDOKTain8");
            user.setPasswordExpiryDate(new java.sql.Timestamp(123456789));
            user.setSessionTimeout(2178);
