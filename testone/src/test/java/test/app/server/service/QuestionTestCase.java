...
import test.app.server.repository.QuestionRepository;
...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("M3uFRwxy58P1GGOcRuUsT0VycAAgpVvZtsDtI1q4dS58cGk3Tm");
            question.setQuestionDetails("BUL");
            question.setQuestionIcon("NOn8TmIBHByAt0ykK4rmSQfitjmMHYL0yQIsxubYU7Ls8uh4Xu");
    ...
    public void test2Update() {
        try {
            ...
            question.setLevelid(2);
            question.setQuestion("9FHVVaoDzZmL6quZH12JPJMkGAQRZx4OSdsifuDS8DF0JZRe6v");
            question.setQuestionDetails("hv9");
            question.setQuestionIcon("JdDbVqhpmicCZOQiXGdPFNbddrqvlZwggklDnIDVSkSNS3eDbe");
