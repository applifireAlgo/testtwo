...
public class BrandTestCase {
    ...
    public void test1Save() {
        try {
            ...
            category.setCategory("ruMf6e9uOqX600KKZ9la86m0EsNWDKNB7Pfrgm3qwFnrqN0ueb");
            Category CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
            Brand brand = new Brand();
            brand.setBranddesc("KCY9RtUTPQEfpx96IpzGp1TuI6WfKZczygtqvcVIvCbBCAYgxS");
    ...
    public void test2Update() {
        try {
            ...
            brand.setBranddesc("auIHEvgbWThYtPHPTJrSphSdU1IgAmZ5yzGwW3kf5zAKfR1BQ5");
