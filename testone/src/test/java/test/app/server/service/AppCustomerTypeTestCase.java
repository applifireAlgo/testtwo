...
public class AppCustomerTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomertype.setCustomerType("mdAfNHTVi0BNotMTo0lTmNzzAN672NNEhNFqk6xaYGgcj2B5c5");
    ...
    public void test2Update() {
        try {
            ...
            appcustomertype.setCustomerType("TtMPPPuXP2hIU7fwH9vmdLQK6RdDFExF4f9rVJJSPBBYofvCNs");
            appcustomertype.setDefaults(0);
            appcustomertype.setSequenceId(2147483647);
